...
import com.erivan.cursomc.services.exceptions.AuthorizationException;
import com.erivan.cursomc.services.exceptions.DataIntegrityException;
import com.erivan.cursomc.services.exceptions.FileException;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> dataIntegrity(DataIntegrityException e, HttpServletRequest request){
		...
		StandardError err = new StandardError(System.currentTimeMillis(), HttpStatus.BAD_REQUEST.value(), "Integriade de dados", e.getMessage(), request.getRequestURI());
